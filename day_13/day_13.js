...
import { person } from "./personObject.js";
import { subtraction, multiply } from "./arithemetic.js";
...
console.log(chalk.bgWhiteBright(chalk.red(greeting.GREETING_MESSAGE) + chalk.green(' I am using the chalk module')))
console.log()
...
file:///home/devesh/Desktop/30_days_javascript/day_13/day_13.js:67
.then((response)=>response.json())
                           ^

TypeError: response.json is not a function
    at file:///home/devesh/Desktop/30_days_javascript/day_13/day_13.js:67:28
    at process.processTicksAndRejections (node:internal/process/task_queues:95:5)

Node.js v22.2.0

The error is occurring because axios returns the response data directly, unlike the Fetch API which requires calling the .json() method to parse the response.
*/
...
.then((respone)=>{
    ...
    console.log(chalk.green(data.slip.advice))
})